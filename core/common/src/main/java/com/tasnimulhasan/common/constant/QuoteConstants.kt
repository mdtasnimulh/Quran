...
object QuoteConstants {
    ...
    const val DHIKRQUOTE1 = "Abu Ad-Darda’ (May Allah be pleased with him) narrated that the Prophet said:\n" +
            "\n" +
    ...
    const val DHIKRQUOTE2 = "Abu Musa Al-Ash`ari (May Allah be pleased with him) narrated that the Prophet said:\n" +
            "\n" +
    ...
    const val DHIKRQUOTE3 = "Abdullah ibn Busr (may Allah be pleased with him) narrated that one of the Prophet’s Companions said, “O Messenger of Allah. I am overwhelmed by the so many injunctions of Islam. So tell me something to which I may hold fast.”\n" +
            "\n" +
            "The Prophet replied, “Keep your tongue wet with the remembrance of Allah.” (At Tirmidhi)"

    const val DHIKRQUOTE4 = "Abu Hurairah also reported that the Prophet (peace and blessings be upon him) said:\n" +
            "\n" +
    ...
    const val DHIKRQUOTE5 = "Zaid ibn Harithah narrated that the Prophet (peace and blessings be upon him) said:\n" +
            "\n" +
            "Whosoever says:\n" +
            "\n" +
            "‘Astaghfirullaha al-`Azeem al-ladhi la ilaha illa howa Al-Hayy al-Qayyum wa atubu illayh (I ask forgiveness of Allah, the Magnificent, than Whom there is no deity, the Living, the Sustainer of existence, and I turn to Him in repentance,)\n" +
            "\n" +
    ...
    const val DHIKRQUOTE6 = "Anas ibn Malik narrated that the Prophet said:\n" +
            "\n" +
    ...
    const val DHIKRQUOTE7 = "Abu Hurairah reported that the Prophet said:\n" +
            "\n" +
    ...
    const val DHIKRQUOTE8 = "Abu Ayyub Al-Ansari (may Allah be pleased with him) reported that the Prophet (peace and blessings be upon him) said:\n" +
            "\n" +
    ...
    const val DHIKRQUOTE9 = "Abu Hurairah narrated that the Prophet said:\n" +
            "\n" +
